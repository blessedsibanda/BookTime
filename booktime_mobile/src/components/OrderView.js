...
import { StyleSheet, Text, Image, TouchableHighlight,
    ...
    return (
      ...
      >
        <View style={styles.orderImage}>
          <OrderImage backendApi={props.backendApi} image={props.
  order.image} />
        </View>
        ...
        return (
            <View style={styles.container}>
                ...
                {this.state.orders.map(m=> (
                    ...
                    setOrderId={orderId => this.setState({
                    orderCurrentId: orderId })}
                    />
                ))}
                </View>
                <ChatView
